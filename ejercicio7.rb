    ...
    #Ejemplo del input: 'Pendrives, 100'
     ...
     #Si el usuario ingresa 2, podrá eliminar un item.
      ...
      when '5'
        ...
        #inventario.each { |k, v| v.each.max }

        #stock = inventario.values.sort[-1]
      ...
      when '6'
        ...
        #Por ejemplo, el usuario ingresará 'Notebooks' y el programa responderá 'Sí'.

      #El programa debe repertirse hasta que el usuario ingrese 7 (salir).
      when '7'
        puts 'Hemos terminado'
    end #end del case
  end
